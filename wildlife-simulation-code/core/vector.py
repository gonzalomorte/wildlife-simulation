...
class Vec2:
    """
    This class provides basic 2D vector arithmetic
    and utility operations such as normalization, magnitude limiting,
    and direction scaling. Used for boid position, velocity, and
